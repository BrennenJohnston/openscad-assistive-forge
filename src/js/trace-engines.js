 ...
 * same shape count, and a line width matching to a hundredth of a millimetre.
 ...
 *
 * Potrace draws in one colour, so Standard keeps the picture's colours with
 * imagetracerjs and Colours is a separate road entirely. The worker decides
